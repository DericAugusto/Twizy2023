		...
		for (int i=0; i<m.height();i++){
			for(int j=0;j<m.width();j++){
				...
				if(BGR[0]==255 && BGR[1]==255 && BGR[2]==255){
					// affiche un point dans la console sans retour sur la ligne
					System.out.print(".");}
				else{//sinon...
			...
			// N'affiche rien mais execute un retour sur la ligne
			System.out.println();
		}

	}

	// Méthode qui ouvre un fichier et renvoie la matrice au format OpenCV
